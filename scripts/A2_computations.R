# A2 - Fossilfreier Anteil verbrannter Abfall ----------------------------------------------------


# Import data -------------------------------------------------------------
# Schritt 1 : hier werden die Daten eingelesen

ds <- create_dataset('A2')
ds <- download_data(ds)
...
A2_computed <- A2_data %>%
  ...
  dplyr::rename("Wert" = "Anteil_fossilfrei") %>%
